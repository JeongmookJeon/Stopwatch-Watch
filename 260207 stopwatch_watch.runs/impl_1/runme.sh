...
HD_PWD='C:/verilog_jjm/260207 stopwatch_watch/260207 stopwatch_watch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_counter_10000.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_counter_10000.tcl -notrace
