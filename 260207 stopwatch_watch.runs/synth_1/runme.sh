...
HD_PWD='C:/verilog_jjm/260207 stopwatch_watch/260207 stopwatch_watch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_counter_10000.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_counter_10000.tcl
